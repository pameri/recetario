...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Receta.detalle'
        db.add_column('principal_receta', 'detalle',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Receta.fecha'
        db.add_column('principal_receta', 'fecha',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Receta.detalle'
        db.delete_column('principal_receta', 'detalle')

        # Deleting field 'Receta.fecha'
        db.delete_column('principal_receta', 'fecha')
